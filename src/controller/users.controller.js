...
const getAllUsers = async (req, res) => {
    // const result = await db.User.findAll({include:{model:db.group,required:true}});
...
const getUserGroup = async (req, res) => {
    ...
    const result = await db.User.findAll({
        include: { model: db.group, required: true },
...
module.exports = { getAllUsers, addUsers, getUser, deleteUser, getUserGroup }